...
//이거는 주어진 예제하에서는 돌아가긴하나
//아무래도 totalSheep += info[curr]
//            totalWolf += 1 - info[curr]  이 부분처럼 이해가 안되는부분(문제와 어긋나는부분)이 존재하기때문에 틀린풀이
//=========================================
 ...
 *
 *
 * => BFS로 테스트 끝. 공부는 꽤 도움되었으나 해결이 되지않아 DFS로 넘어갈것임.
 */